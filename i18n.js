...
window.I18N_STRINGS = {
  en: {
    "meta.description": "Registro Coletivo is Cordel 2.0's territorial archive: popular writing and woodcut anchored to the ground they come from, with a 3D cultural-space builder for the community.",
    "skip": "Skip to content",
    "nav.metades": "What it is", "nav.territorio": "Territory", "nav.estado": "Status",
    ...
    "ter.s1": "Ground", "ter.s1d": "Built from open OpenStreetMap data.",
    "ter.s2": "Anchored work", "ter.s2d": "Dilma Santana's cordel, from the Primeira Edição Alagados anthology.",
    "ter.s3": "Provenance", "ter.s3d": "ISBN 978-65-89484-02-8, cited and verifiable.",
    "ter.s4": "Vantage point", "ter.s4d": "A place from which to look at the territory and read the work.",
    "ter.s5": "Checking", "ter.s5d": "The verse is checked character by character against the original.",
    "ter.s6": "Name", "ter.s6d": "The MVP's final name will be chosen with the community.",
    ...
    "est.k5": "What is new", "est.v5": "The platform. The work in the territory is not",
    "dec.index": "05 / DECISIONS",
    "dec.title": "Whoever enters<br>is not measured.",
    ...
    "for.index": "06 / TRAINING",
    "for.title": "The product is training.<br>The software is the means.",
    "for.lead": "Cordel 2.0 is a training, consulting and pedagogical design startup. Raising in 3D the square named in a cordel teaches reading, writing, cartography and digital literacy at once.",
    "for.c1.h": "Institutes and museums", "for.c1.p": "Territorial archive for collections and artistic residency programmes.",
    "for.c2.h": "Cultural policy", "for.c2.p": "Living-heritage records with community participation, in departments, libraries and culture points.",
    "for.c3.h": "Collectives and poets", "for.c3.p": "A place to anchor your own work to your own ground.",
    "for.c4.h": "The workshop is the product", "for.c4.p": "The community does not receive a finished map: it raises its own territory.",
    "cta.eyebrow": "Workshops · programmes · consulting · pedagogical design",
    "cta.title": "The territory belongs<br>to those who live it.",
  ...
  zh: {
    "meta.description": "Registro Coletivo 是 Cordel 2.0 的地域档案：把民间写作与木刻锚定在它们诞生的土地上，并为社区提供 3D 文化空间搭建工具。",
    "skip": "跳到主要内容",
    "nav.metades": "这是什么", "nav.territorio": "地域", "nav.estado": "现状",
    ...
    "ter.s1": "土地", "ter.s1d": "基于 OpenStreetMap 开放数据构建。",
    "ter.s2": "已锚定的作品", "ter.s2d": "Dilma Santana 的民谣诗，出自 Primeira Edição Alagados 选集。",
    "ter.s3": "来源", "ter.s3d": "ISBN 978-65-89484-02-8，可引用、可核验。",
    "ter.s4": "观景点", "ter.s4d": "一个可以眺望该地域并阅读作品的位置。",
    "ter.s5": "核对", "ter.s5d": "诗句逐字与原文核对。",
    "ter.s6": "命名", "ter.s6d": "MVP 的最终名称将与社区共同确定。",
    "est.index": "04 / 如实说明",
    ...
    "est.k5": "新的部分", "est.v5": "是这个平台。在该地域的工作并不新",
    "dec.index": "05 / 设计抉择",
    "dec.title": "进来的人<br>不被测量。",
    "dec.lead": "这些抉择比任何功能清单更能说明这个产品。",
    "dec.s1": "纯静态", "dec.s1d": "访问期间没有后端、账号、Cookie、分析工具或第三方请求。",
    "dec.s2": "场景先等待", "dec.s2d": "来访者先看到一张轻量海报，再决定是否进入。",
    "dec.s3": "3G 下的安卓机", "dec.s3d": "这是明确的性能目标，而不是办公室台式机。",
    "dec.s4": "开放数据", "dec.s4d": "OpenStreetMap，遵循 ODbL，并在页脚署名。",
    "dec.s5": "交叉审计", "dec.s5d": "投影由与生成场景不同的公式另行核验。",
    "dec.s6": "诗句无误", "dec.s6d": "错误地发布他人的诗句，等于一边声称保存、一边抹去这个人。",
    "for.index": "06 / 培训",
    "for.title": "产品是培训。<br>软件是途径。",
    "for.lead": "Cordel 2.0 是一家从事培训、咨询与教学设计的初创企业。用 3D 立起民谣诗中写到的广场，能同时教会阅读、写作、制图与数字素养。",
    "for.c1.h": "机构与博物馆", "for.c1.p": "面向馆藏与艺术驻留项目的地域档案。",
    "for.c2.h": "文化政策", "for.c2.p": "在文化部门、图书馆与社区文化点开展有社区参与的活态遗产记录。",
    "for.c3.h": "团体与诗人", "for.c3.p": "一个把自己的作品锚定在自己土地上的地方。",
    "for.c4.h": "工作坊即产品", "for.c4.p": "社区拿到的不是一张做好的地图：他们自己立起自己的地域。",
    "cta.eyebrow": "工作坊 · 项目 · 咨询 · 教学设计",
    "cta.title": "地域属于<br>生活在其中的人。",
...
(function () {
  var KEY = 'cordel2-lang';
  var LOCALES = { pt: 'pt-BR', en: 'en', zh: 'zh-Hans' };
  ...
  function apply(lang) {
    ...
    var table = lang === 'pt' ? null : dict[lang];
    nodes().forEach(function (el) {
      var k = el.getAttribute('data-i18n');
      var v = table && table[k];
      el.innerHTML = typeof v === 'string' ? v : originals.get(el);
    });

    document.documentElement.lang = LOCALES[lang] || 'pt-BR';

    var desc = document.querySelector('meta[name="description"]');
    if (desc) {
      var dk = table && table['meta.description'];
      if (!desc.dataset.pt) desc.dataset.pt = desc.getAttribute('content');
      desc.setAttribute('content', dk || desc.dataset.pt);
    }
